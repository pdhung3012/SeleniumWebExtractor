...
public class DownloadLeetCodeDiscussion {
	...
	public static void main(String[] args) {
		...
		String fpSucess="/Users/hungphan/git/translationExample/discussion/leet_ok.txt";
		String fpFail="/Users/hungphan/git/translationExample/discussion/leet_fail.txt";
...
//			}
//			.split("\t")[1]
			String url = arrUrls[i].split("\t")[1].trim().replaceFirst("/solution/","/discussion/").trim();
